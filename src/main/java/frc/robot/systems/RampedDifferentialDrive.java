 ...
 */
public class RampedDifferentialDrive extends RobotDriveBase implements Sendable, AutoCloseable {
   ...
   */
  public RampedDifferentialDrive(SpeedController leftMotor, SpeedController rightMotor) {
